...
* Quotes
One of the most irritating things programmers do regularly is feel so good about
learning a hard thing that they don't look for ways to to make it easy, or even
oppose things that would do so. (Peter Bhat Harkins)

[C++ is] just a garbage heap of ideas that are mutually exclusive. Everybody I
know, whether it’s personal or corporate, selects a subset and these subsets are
different. ... [Stroustrup] put every feature in that language that ever
existed. (Ken Thompson, Coders at Work)
...
** [[https://www.cppstories.com/2017/01/cpp17features/][All Major C++17 Features You Should Know - C++ Stories]]
...
* Python
** [[https://wireframe.raspberrypi.com/books/code-the-classics1][Code the Classics – Volume 1 — Wireframe Magazine]]
...
- [[https://doc.rust-lang.org/nomicon/][Introduction - The Rustonomicon]]
...
- [[https://rust-unofficial.github.io/patterns/][Introduction - Rust Design Patterns]]
- [[https://github.com/rust-unofficial/awesome-rust][GitHub - rust-unofficial/awesome-rust: A curated list of Rust code and resour...]]
- [[https://nnethercote.github.io/perf-book/][Title Page - The Rust Performance Book]]
- [[https://rust-lang.github.io/async-book/][Getting Started - Asynchronous Programming in Rust]]
- [[https://tokio.rs/tokio/tutorial][Tutorial | Tokio - An asynchronous Rust runtime]]
...
- [[https://github.com/ossu/computer-science][GitHub - ossu/computer-science: Path to a free self-taught education in Compu...]]
- [[https://romanbird.github.io/sicp/][Structure and Interpretation of Computer Programs]]

* Touch Typing
** [[https://thetypingcat.com/][The Typing Cat - Touch Typing Tutor - Learn To Type]]
** [[https://www.keybr.com/][Typing Practice]]
** [[https://monkeytype.com/][Monkeytype]]
** [[https://ikario.com/type-faster-touch-typing-for-beginners/][How to Type Faster: Touch Typing for Beginners]]
** [[https://10fastfingers.com/typing-test/][Typing Test English - 10FastFingers.com]]
** [[https://play.typeracer.com/][TypeRacer]]
** [[https://www.nitrotype.com/][Nitro Type | Competitive Typing Game | Race Your Friends]]
** [[https://typings.gg/][typings]]

* Project Ideas
- [[https://projectbook.code.brettchalupa.com/][Introduction - Projectbook]]
- [[https://github.com/practical-tutorials/project-based-learning][GitHub - practical-tutorials/project-based-learning: Curated list of project-...]]
- [[https://codecrafters.io/][Build your own X. Master any language.]]

* Where to start writing a OS/kernel?
** [[https://osdev.org][Expanded Main Page - OSDev Wiki]]  is the defacto reference. Start with AMD64, don't bother with x86 (32-bit). Segmentation is a nightmare and there are less quirks with AMD64.
...
* Daily Tasks
A journal of the tasks that I have to do in this week
** Monday
*** WAIT Golang
...
* Project Ideas
** Write a taskbar alternative that has systray and all. For example it should have usb, bluetooth etc. systray icons. It will be a complete replacement to the standard windows one. Not just a application launcher. It should be summoned with Win + Space.
